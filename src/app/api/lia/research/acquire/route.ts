...
export async function POST(request:Request){
 ...
 try{
  ...
  const result=await acquireSource({url:body.url.trim(),maxBytes:typeof body.maxBytes==="number"?body.maxBytes:undefined,timeoutMs:typeof body.timeoutMs==="number"?body.timeoutMs:undefined,maxRedirects:typeof body.maxRedirects==="number"?body.maxRedirects:undefined,allowedHosts:entry?[entry.domain]:[]});
