...
const checks = [
  ...
  ["auto-cron provisions continuous operation", files.autoCron.includes("continuous_operations") && files.autoCron.includes("0 20 * * *") && files.autoCron.includes('timezone: "UTC"')],
